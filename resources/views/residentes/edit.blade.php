...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1 fs-3">Editar Residente</h2>
            <p class="text-muted small mb-0">Modifique los datos personales, de contacto o la condición del habitante seleccionado.</p>
        </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control px-3" value="{{ old('nombre', $residente->nombre) }}" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="apellido" class="form-label fw-medium text-secondary">Apellido(s)</label>
                            <input type="text" name="apellido" id="apellido" class="form-control px-3" value="{{ old('apellido', $residente->apellido) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="ci" id="ci" class="form-control px-3" value="{{ old('ci', $residente->ci) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control px-3" value="{{ old('email', $residente->email) }}" required>
                            </div>
                        </div>
